...
### 2. macOS PyQt5 版本 (emby115_v1/qt_main.py) ⭐ 推荐
```bash
python emby115_v1/qt_main.py
```
- **原生支持 macOS 拖拽**
- 支持单个/多个文件夹拖拽
- 现代化界面
...
| 功能 | Windows (main.py) | macOS (emby115_v1/qt_main.py) |
|------|-------------------|-------------------|
| 窗口显示 | ✅ | ✅ |
| 文件浏览 | ✅ | ✅ |
| **拖拽功能** | ✅ | ✅ **原生支持** |
...
├── emby115_v1/qt_main.py           # macOS PyQt5 版本入口 ⭐
├── emby115_v1/qt_gui/              # PyQt5 界面模块
│   ├── main_window.py
...
│   └── ...
└── emby115_v1/tabs/                # tkinter 界面模块（Windows 专用）
```

### 设计原则
- `main.py`: 保持 Windows 版本完整不变
- `emby115_v1/qt_main.py` + `emby115_v1/qt_gui/`: 独立的 PyQt5 模块，专用于 macOS
- 代码完全隔离，无冲突风险

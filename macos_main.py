...
PYQT_UNSUPPORTED_MESSAGE = (
    "macos_main.py 仅支持 macOS；Windows 请使用 tkinter 版本：python windows_main.py；Linux 不再支持。"
)
...
def main():
    ...
    try:
        ...
        app.setApplicationDisplayName("Emby115Toolkit - macOS PyQt5")

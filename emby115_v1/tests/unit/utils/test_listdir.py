...
class TestListFiles:
    ...
    def test_list_files_basic(self, temp_dir, create_test_file_structure):
        """测试基本的文件列表功能"""
        from emby115_v1.utils.listdir import list_files
...
class TestGetFileCount:
    ...
    def test_get_file_count_basic(self, temp_dir, create_test_file_structure):
        """测试基本的文件计数功能"""
        from emby115_v1.utils.listdir import get_file_count
...
class TestGenerateOutputFilename:
    ...
    def test_generate_output_filename(self):
        """测试生成输出文件名"""
        from emby115_v1.utils.listdir import generate_output_filename

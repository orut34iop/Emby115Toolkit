...
class TestEmbyOperatorServerType:
    ...
    def test_validate_server_type_stops_on_mismatch(self, monkeypatch):
        ...
        monkeypatch.setattr('emby115_v1.emby.EmbyOperator.requests.get', fake_get)
        operator = EmbyOperator(
            emby_url='http://localhost:8096',
            emby_api='test-api-key',
            server_type='emby'
    ...
    def test_jellyfin_merge_versions_uses_jellyfin_path_and_ids_param(self, monkeypatch):
        ...
        monkeypatch.setattr('emby115_v1.emby.EmbyOperator.requests.request', fake_request)
        operator = EmbyOperator(
            emby_url='http://localhost:8096',
            emby_api='test-api-key',
            server_type='jellyfin'
    ...
    def test_item_update_retries_timeout(self, monkeypatch):
        ...
        monkeypatch.setattr('emby115_v1.emby.EmbyOperator.requests.request', fake_request)
        monkeypatch.setattr('emby115_v1.emby.EmbyOperator.time.sleep', lambda seconds: None)

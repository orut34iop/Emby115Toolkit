...
class TestTreeMirrorInit:
    ...
    def test_init_with_default_values(self, temp_dir):
        ...
        mirror = TreeMirror(tree_file='tree.txt', export_folder=temp_dir)
    ...
    def test_init_with_fix_garbled(self, temp_dir):
        ...
        mirror = TreeMirror(tree_file='tree.txt', export_folder=temp_dir, fix_garbled_text=True)
...
class TestTreeMirrorParseTree:
    ...
    def test_parse_simple_tree(self, temp_dir, sample_tree_content):
        ...
        mirror = TreeMirror(tree_file=tree_file, export_folder=temp_dir)
...
"""
        ...
        mirror = TreeMirror(tree_file=tree_file, export_folder=temp_dir, fix_garbled_text=True)
